...
#CATALINA_OPTS="-Dcatalina.home=$CATALINA_HOME -Dcatalina.base=$CATALINA_BASE -Dorg.apache.activemq.UseDedicatedTaskRunner=false -Dactivemq.home=$ACTIVEMQ_HOME -Dactivemq.base=$ACTIVEMQ_BASE -Dcom.sun.management.jmxremote -Dcom.sun.management.jmxremote.port=8099 -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.authenticate=false -server -Xms128m -Xmx256m -Djava.net.preferIPv4Stack=true -Djava.awt.headless=true -XX:+PrintTenuringDistribution -verbose:gc -Xloggc:$CATALINA_HOME/logs/garbage.log -XX:+PrintGCDetails"

...
#CATALINA_HOME=@@CATALINA_HOME@@;export CATALINA_HOME
...
#CATALINA_OPTS="-Dcatalina.home=$CATALINA_HOME -Dcatalina.base=$CATALINA_BASE -Dhazelcast.mancenter.home=$CATALINA_BASE/data/hazelcast -Dspring.profiles.active=dev -Dorg.apache.activemq.UseDedicatedTaskRunner=false -Dactivemq.home=$ACTIVEMQ_HOME -Dactivemq.base=$ACTIVEMQ_BASE -Dcom.sun.management.jmxremote -Dcom.sun.management.jmxremote.port=8099 -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.authenticate=false -Dorg.apache.activemq.store.kahadb.LOG_SLOW_ACCESS_TIME=200 -server -Xms128m -Xmx128m -Djava.net.preferIPv4Stack=true -Djava.awt.headless=true -XX:+UseParNewGC -XX:+UseConcMarkSweepGC -XX:PrintFLSStatistics=1 -XX:PrintCMSStatistics=1 -XX:+PrintTenuringDistribution -XX:+PrintGCDetails -XX:+PrintGCDateStamps -verbose:gc -Xloggc:%CATALINA_HOME%/logs/garbage.log"
